...
namespace projedenemeleri1
{
    class data
    {
        ...
        public static int leap_finger_thumb { get; set; }
        public static int leap_finger_index { get; set; }
        public static int leap_finger_middle { get; set; }
        public static int leap_finger_ring { get; set; }
        public static int leap_finger_pinky { get; set; }
    }
}
